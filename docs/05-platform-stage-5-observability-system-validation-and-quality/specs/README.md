...
状态：Slice 1A Spec 已接受

- [Spec 001：完整且安全的运行摘要合同](001-complete-safe-run-summary-contract.md)
- [Spec 002：Provider Call 与人民币成本事实基础](002-provider-call-cost-foundation.md)（已接受）
